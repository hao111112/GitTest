...
//     try {
//       const response = await axios.post('http://kocu.cswallet.co/api/shop/list');
//       const data = response.data as Shop[];
//       setShopList(data);
//     } catch (error) {
...
//           </IconButton>
//           <Box
//             sx={{ flexGrow: 1, textAlign: 'center', position: 'relative', left: '15px' }}
//           >
...
//           </Box>
//           <div /> {/* 添加弹性空间 */}
//           <Button onClick={handleScanClick} color="primary" startIcon={<img src={QRcodesvg} alt="Scan QR Code" />}>
//             掃碼
//           </Button>
//           <IconButton
//             size="large"
...
//         <Grid container justifyContent="center" alignItems="center" mt={2}>
//           {shopList
//             .filter((shop) => selectedCategory === '全部' || shop.category === selectedCategory)
//             .map((shop) => (
//               <div key={shop.id} className="shop-card">
//                 <img src={shop.logo} alt={shop.title} className="shop-logo" />
//                 <div className="shop-info">
//                   <h3 className="shop-title">{shop.title}</h3>
//                   <p className="shop-address">{shop.address}</p>
//                 </div>
//                 <div className="shop-action">
//                   <img src={offsvg} alt="Off" className="off-icon" />
//                   <Button
//                     variant="contained"
//                     color="primary"
//                     startIcon={<img src={QRcodesvg} alt="Scan QR Code" />}
//                     onClick={() => handleBuyClick(shop.id)}
//                   >
//                     購買
//                   </Button>
//                 </div>
...
const Cart: React.FC<CartProps> = ({ setSelectedTab }) => {
    ...
    const handleCartCategoryClick = (categoryName: String) => {
        // 在这里添加图标点击事件的处理逻辑
        history.push(`/cartCategory/${categoryName}`);
    };
    const history = useHistory();
                    ...
                    <div className='mt-6' style={{ overflowX: 'auto', whiteSpace: 'nowrap' }}>
                        ...
                        <div className='flex ' >
                            {sorts.map((sort, index) => (
                                <div key={index} className='cart_types ' style={{ flexShrink: 0 }} onClick={() => handleCartCategoryClick(sort.name)}>
